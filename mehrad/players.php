...
<body>
    ...
    <section class="contain">
		<div class="middle">
			...
			<div class="players">
				<div class="">
                    <img src="images/tehranipour.jpg" height="200" alt="">
                    <p>
                        
                        نوازنده تنبور
                        متولد کرمان وی از نه سالگی با شروع نوازندگی نی لبک با دنیای موسیقی آشنا شد و
                        در مسابقات کودکان و نوجوانان رتبه ی اول را کسب نمود. از سال 88 تنبور را نزد استاد
                        فراز کاویانی فرا گرفت و با پیشرفتی چشمگیر به تنبورنوازان حنان پیوست وی نزد استاد سالاری
                        نصب به صدا سازی میپردازد و افتخار اجرا به همراه استاد کاویانی و استاد رضائی نیا را داشته است.
                    </p>
                </div>
                <div class="">
                    <img src="images/benyamin.jpg" width="200" height="200" alt="">
                    <p>
                ...
                <div class="">
                    <img src="images/hooman.jpg" width="200" height="200" alt="">
                    <p>
                ...
                <div class="">
                    <img src="images/saeed.jpg" width="200" height="200" alt="">
                    <p>
                    نوازنده تنبور
                    متولد کرمان وی از نه سالگی با شروع نوازندگی نی لبک با دنیای موسیقی آشنا شد و
                    در مسابقات کودکان و نوجوانان رتبه ی اول را کسب نمود. از سال 88 تنبور را نزد استاد
                ...
                <div class="">
                    <img src="images/tehranipour.jpg" width="200" height="200" alt="">
                    <p>
                        نوازنده تنبور
                        متولد کرمان وی از نه سالگی با شروع نوازندگی نی لبک با دنیای موسیقی آشنا شد و
                        در مسابقات کودکان و نوجوانان رتبه ی اول را کسب نمود. از سال 88 تنبور را نزد استاد
